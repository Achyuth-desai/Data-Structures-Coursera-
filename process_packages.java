    ...
    public Response Process(Request request) {
        ...
        if(finish_time_.isEmpty()){
        	...
        	if(finish_time_.size() == this.size_)
        		...
        		int fin_time = finish_time_.get(finish_time_.size()-1) + request.process_time;
        		finish_time_.add(fin_time);
        		return new Response(false, fin_time - request.process_time);
        	}
	}        
